...
<!-- END header -->
    ...
    <section class="section bg-light py-5  bottom-slant-gray">
      ...
      <center>
        <p data-aos="fade-up" data-aos-delay="200"><a href="services_admin.php" class="btn btn-more btn-outline-more">More Service</a></p>
      </center>
    ...
    <section class="section pb-0">
      <div class="container">
        ...
        <?php
            ...
            <a href="forminsertket.php">Insert</a>
            <a href="form_update_ket.php?id=<?php echo $row['id'];?>">Update</a>
            <a href="delete_ket.php?id=<?php echo $row['id'];?>">Delete</a>
            <?php
                }
            }
        ?>    
    ...
    <section class="section ">
      ...
      <div class="clearfix mb-5 pb-5">
        <div class="container-fluid mb-5">
          <div class="row" data-aos="fade">
            <div class="col-md-12 text-center heading-wrap">
              ...
              <a href="form_insert_gambar_dr.php">Insert</a>
              <a href="form_delete_dr.php">Delete</a>
            </div>
          </div>
        </div>
          </div>
        ...
        if(!empty($result_pic_ket)) { 
          ...
          <a href="form_Update_gambar_dr.php?id=<?php echo $row['id'];?>" class="item-doctor" data-aos="fade-right" data-aos-delay="100">
            <div class="text">
              <h2 class="doctor-heading"><?php echo $row["nama_dr"];?>
               </h2>
            <p>Update</p>
            </div>
